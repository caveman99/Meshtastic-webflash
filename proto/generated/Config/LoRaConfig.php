 ...
 */
class LoRaConfig extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     */
    protected $frequency_offset = 0.0;
    /**
     ...
     *
     * Generated from protobuf field <code>bool override_duty_cycle = 12;</code>
     */
    protected $override_duty_cycle = false;
    /**
     ...
     *           Certain bandwidth numbers are 'special' and will be converted to the
     *           appropriate floating point value: 31 -> 31.25MHz
     *     @type int $spread_factor
     *           A number from 7 to 12.
     *           Indicates number of chirps per symbol as 1<<spread_factor.
     *     @type int $coding_rate
     *           The denominator of the coding rate.
     *           ie for 4/5, the value is 5. 4/8 the value is 8.
     *     @type float $frequency_offset
     *           This parameter is for advanced users with advanced test equipment, we do not recommend most users use it.
     *           A frequency offset that is added to to the calculated band center frequency.
     *           Used to correct for crystal calibration errors.
     *     @type int $region
    ...
    {
        GPBUtil::checkEnum($var, \Config\LoRaConfig\ModemPreset::class);
    ...
    {
        GPBUtil::checkEnum($var, \Config\LoRaConfig\RegionCode::class);
        $this->region = $var;
     ...
     * @return bool
     */
    public function getOverrideDutyCycle()
    {
        return $this->override_duty_cycle;
    }
     ...
     * @return $this
     */
    public function setOverrideDutyCycle($var)
    {
        GPBUtil::checkBool($var);
        $this->override_duty_cycle = $var;
...
class_alias(LoRaConfig::class, \Config_LoRaConfig::class);
