 ...
 */
class PositionConfig extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     */
    protected $gps_update_interval = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>uint32 rx_gpio = 8;</code>
     */
    protected $rx_gpio = 0;
    /**
     * (Re)define GPS_TX_PIN for your board.
     *
     * Generated from protobuf field <code>uint32 tx_gpio = 9;</code>
     */
    protected $tx_gpio = 0;
     ...
     *
     *     @type int $position_broadcast_secs
     *           We should send our position this often (but only if it has changed significantly)
     *           Defaults to 15 minutes
     *     @type bool $position_broadcast_smart_enabled
     *           Adaptive position braoadcast, which is now the default.
     *     @type bool $fixed_position
     *           If set, this node is at a fixed position.
     *           We will generate GPS position updates at the regular interval, but use whatever the last lat/lon/alt we have for the node.
     *           The lat/lon/alt can be set by an internal GPS or with the help of the app.
     *     @type bool $gps_enabled
     *           Is GPS enabled for this node?
     *     @type int $gps_update_interval
     *           How often should we try to get GPS position (in seconds)
     *           or zero for the default of once every 30 seconds
     *           or a very large value (maxint) to update only once at boot.
     *     @type int $gps_attempt_time
     *           How long should we try to get our position during each gps_update_interval attempt?  (in seconds)
     *           Or if zero, use the default of 30 seconds.
     *           If we don't get a new gps fix in that time, the gps will be put into sleep until  the next gps_update_rate
     *           window.
...
class_alias(PositionConfig::class, \Config_PositionConfig::class);
